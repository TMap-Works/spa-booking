 ...
 * des schémas à écrire — et l'écriture n'est pas mécanique : elle demande de
 * trancher la casse de `SALE_ITEM_KINDS`, que la colonne écrit en majuscules et
 * que le contrat nomme partout ailleurs en minuscules (premier point de
 * vigilance de #510). Même constat que dans `pos.types.ts`.
 */
