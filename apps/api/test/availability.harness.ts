 ...
 * deux.
 *
 * ## Les neuf routes de back-office, un seul harnais
 *
 * #32 servait les horaires récurrents et les jours de fermeture — quatre routes
 * qui ne s'appuient que sur `AvailabilityRepository` ; #33 a ajouté les cinq
 * routes des absences, qui s'appuient sur `StaffTimeOffRepository` et sur le
 * cache.
