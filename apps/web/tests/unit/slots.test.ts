 ...
 *
 * Le choix de la **date** s'éprouve depuis #827 dans
 * [month-grid.test.ts](month-grid.test.ts) : la bande de journées y a cédé la
 * place à un calendrier mensuel, et son arithmétique avec elle.
 */
