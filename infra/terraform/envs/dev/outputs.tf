...
# `notification_sms_sender_id` qui y renvoie, et l'expéditeur se pose dans les
# trois environnements depuis #918. Sans cette sortie, `terraform output
# notification_sms_sender_id_registration` échouait sur « output not found »
# exactement là où l'opérateur venait d'arrêter un expéditeur.
