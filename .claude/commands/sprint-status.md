...
2. **En cours** — qui travaille sur quoi, et depuis combien de temps. Signaler
   toute branche ouverte depuis plus de 5 jours ouvrés.
3. **Bloqué** — PR en attente de revue, CI rouge, issues `P0` non commencées.
4. **Risque sur le jalon** — au vu du reste à faire, le critère de franchissement
   du jalon de fin de semaine est-il atteignable ? Dire oui ou non clairement,
   avec ce qu'il faudrait décaler le cas échéant.
5. **Périmètre** — issues créées cette semaine sans milestone ou labellisées
